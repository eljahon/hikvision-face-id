...
export class NotificationService {
    ...
    async findAll(query: PaginationDto): Promise<PaginationResult<NotificationEntity>> {
    ...
    async create(data: NotificationDto): Promise<NotificationEntity> {
        const item = this.notificationRepository.create(data)
    ...
    //  }
    async getPaginatedItemsFromDatabase(page: number, pageSize: number): Promise<[NotificationEntity[], number]> {
